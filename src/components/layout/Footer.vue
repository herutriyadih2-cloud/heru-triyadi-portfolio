  ...
  <footer class="bg-[#0a0b0b] border-t border-slate-900 py-12">
    <div class="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        <a 
          href="https://github.com/herutriyadih2-cloud" 
          target="_blank" 
          class="p-2.5 bg-slate-900 border border-slate-800 text-slate-400 hover:text-white hover:border-slate-700 rounded-xl transition-all hover:-translate-y-0.5"
          title="GitHub"
        >
        ...
        <a 
          href="mailto:herutriyadih2@gmail.com" 
          class="p-2.5 bg-slate-900 border border-slate-800 text-slate-400 hover:text-red-400 hover:border-red-400/30 rounded-xl transition-all hover:-translate-y-0.5"
          title="Email"
        >
